...
# # CDD options
# __C.CDD = edict()
# __C.CDD.KERNEL_NUM = (5, 5, 5)
# __C.CDD.KERNEL_MUL = (2, 2, 2)
# __C.CDD.LOSS_WEIGHT = 0.3
# __C.CDD.ALIGNMENT_FEAT_KEYS = ['feat', 'probs1','probs2']
# __C.CDD.INTRA_ONLY = False

__C.PARAMS = edict()
__C.PARAMS.CON_LOSS = 0.1
__C.PARAMS.IM_LOSS = 0.1
